...
<!-- Morris显示图表 -->
<link href="${webRoot}/resources/admin/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
</head>
<body class="gray-bg">
    ...
    <script src="${webRoot}/resources/admin/js/plugins/flot/jquery.flot.js"></script>
    <script src="${webRoot}/resources/admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${webRoot}/resources/admin/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${webRoot}/resources/admin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${webRoot}/resources/admin/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${webRoot}/resources/admin/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="${webRoot}/resources/admin/js/plugins/peity/jquery.peity.min.js"></script>
     
    <script src="${webRoot}/resources/admin/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="${webRoot}/resources/admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${webRoot}/resources/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
     <!-- 
