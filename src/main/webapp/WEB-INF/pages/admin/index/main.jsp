...
<%-- <script src="${webRoot}/resources/jquery/jquery-1.11.0.min.js"></script> --%>
</head>
<body class="fixed-sidebar full-height-layout gray-bg"
					...
					<li class="nav-header"
						...
						<div class="dropdown profile-element">
							<span><img alt="image" class="img-circle"
								src="${webRoot}/resources/admin/img/profile_small.jpg" /></span> <a
							...
							<ul class="dropdown-menu dropdown-messages">
								<li class="m-t-xs">
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle"
											src="${webRoot}/resources/admin/img/a7.jpg">
										</a>
								...
								<li>
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle"
											src="${webRoot}/resources/admin/img/a4.jpg">
										</a>
										<div class="media-body ">
						...
						<div>
								...
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="${webRoot}/resources/admin/img/a1.jpg">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="${webRoot}/resources/admin/img/a2.jpg">
									</div>
									<div class="media-body">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="${webRoot}/resources/admin/img/a3.jpg">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="${webRoot}/resources/admin/img/a8.jpg">
									</div>
									<div class="media-body">
	...
	<script
		src="${webRoot}/resources/admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
	<script
		src="${webRoot}/resources/admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
	<script src="${webRoot}/resources/admin/js/plugins/layer/layer.min.js"></script>
	<script src="${webRoot}/resources/admin/js/hplus.min.js?v=4.0.0"></script>
	<script src="${webRoot}/resources/admin/js/contabs.min.js"
		type="text/javascript"></script>
	<script src="${webRoot}/resources/admin/js/plugins/pace/pace.min.js"></script>
	<script src="${webRoot}/resources/admin/index/menu.js"
		type="text/javascript"></script>
