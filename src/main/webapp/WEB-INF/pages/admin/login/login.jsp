...
<link href="${webRoot}/resources/admin/login/login.min.css"
	rel="stylesheet">
<!--[if lt IE 8]>
...
<body class="signin">
	...
	<script src="/shabao-sys/resources/jquery/jquery-1.11.0.min.js"></script>
	<script src="/shabao-sys/resources/admin/login/login.js"></script>
</body>
</html>