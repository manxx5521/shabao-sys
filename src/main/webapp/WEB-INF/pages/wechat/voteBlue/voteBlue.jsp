...
<body>
	...
	<style>
.music {
	background: url("${webRoot}/resources/wechat/voteBlue/images/music.png")
	...
	<header>
		<div class="m_head clearfix">
			...
			<div class="num_box">
				...
				<a href="./voteBuleBaoMing.html?vote_id=${vote_id}"
					class="join_us">我要报名</a>
				<ul class="num_box_ul">
					<li><span class="text">已报名</span><span>18</span></li>
					<li><span class="text">投票人次</span><span>15786</span></li>
					<li><span class="text">访问量</span><span>97922</span></li>
				</ul>
	...
	<section class="content" id="get_info" data-rid="503" data-sort=""
		...
		<div id="pageCon" class="match_page masonry"
			...
			<ul class="list_box masonry clearfix" style="position: relative;">
				...
				<li class="picCon">
					<div>
						<i class="number">${r.player_num}号</i><a
							href="./voteBuleDetail.html?player_id=${r.player_id}"
							class="img"><img
							src="${webRoot}/resources/upload/images/vote/${r.image}"
							alt=""></a>
						<div class="clearfix">
							<p>
								${r.player_name}<br />${r.vote_num}票
							</p>
...
.pagination a {
	...
	<script src="${webRoot}/resources/wechat/voteBlue/yxMobileSlider.js" type="text/javascript"></script>
	<script type="text/javascript">
