...
<script src="${webRoot}/resources/js/jquery/jquery.artDialog/jquery.artDialog.js?skin=default"></script>
<script src="${webRoot}/resources/js/iframeTools.js"></script>
<script src="${webRoot}/resources/wechat/voteBlue/upyun.js?2013"></script>
<link rel="stylesheet"
	href="${webRoot}/resources/js/jquery/Swiper/idangerous.swiper.css">
<script
	src="${webRoot}/resources/js/jquery/Swiper/idangerous.swiper.min.js"></script>
<style>
.slider {
	display: none;
}
	...
	width: 100%
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<a href="#"><img class="imgplay"
								src="${webRoot}/resources/wechat/voteBlue/images/568358a53332e.png" /></a>
						</div>
						<div class="swiper-slide">
							<a href="#"><img class="imgplay"
								src="${webRoot}/resources/wechat/voteBlue/images/568357a9a4d81.png" /></a>
						</div>
					</div>
				</div>
		...
		<div class="m_head clearfix">
			<div class="num_box">
				...
				<img src="${webRoot}/resources/wechat/voteBlue/images/mw_004.jpg">
			</div>
		</div>
	</header>
	<div class="apply">
			...
			<dl class="upload clearfix">
				...
				<dd class="upload_area clearfix">
					...
					<input type="button" name="button" value=""
						style="background: url(${webRoot}/resources/wechat/voteBlue/images/upload_btn.png) center no-repeat; background-size: 60px auto; float: left; overflow: hidden; position: relative; width: 60px; height: 60px;"
	...
	<section class="rules">
		<div class="text">
			...
			<div class="neirong">
				...
				<p>奖品设置：</p>
				<p>
					<img alt="" src="${webRoot}/resources/wechat/voteBlue/images/55ec2d38ae11d.jpg" />
				</p>
				<p>
					<img alt="" src="${webRoot}/resources/wechat/voteBlue/images/55ec2daa83e50.jpg" />
				</p>
				<center>
					<a href="http://www.lanrenmb.com" style="color: #5e5e5e; font-size: 12px;">Copyright (c) 2014-2016 沙包娱乐 版权所有</a>
				</center>
			</div>
	</section>
	<!--
