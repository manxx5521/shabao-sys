...
import com.xiaoshabao.framework.wechat.api.core.req.WeiXinReqService;
import com.xiaoshabao.framework.wechat.api.core.req.model.media.DownloadMedia;
import com.xiaoshabao.framework.wechat.api.core.req.model.media.UploadMedia;
import com.xiaoshabao.framework.wechat.api.core.util.WeiXinReqUtil;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxArticlesRequest;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxArticlesRequestByMaterial;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxArticlesRespponseByMaterial;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxCountResponse;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxDescriptionRequest;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxDwonload;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxMediaForMaterial;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxMediaForMaterialResponse;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxNews;
import com.xiaoshabao.framework.wechat.api.wxmedia.model.WxUpdateArticle;
			...
			if (accesstoken != null) {
				...
				for (WxArticle article : wxArticles) {
					if (article.getFileName() != null
						...
						try {
							String mediaId = JwSendMessageAPI.getFileMediaId(
									accesstoken, article);
