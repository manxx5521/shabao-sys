...
public class HttpRequestProxy {
	 ...
	 * @return HTTP响应的字符串
	 */
	public static String doGet(String reqUrl, Map<String, Object> parameters,
			String recvEncoding) {
	 ...
	 * @return HTTP响应的字符串
	 */
	public static String doJsonPost(String reqUrl, Map<String, Object> parameters,
			String jsonData) {
		HttpURLConnection url_con = null;
		String responseContent = null;
		try {
	 ...
	 * @return
	 */
	public static String uploadMedia(String reqUrl, Map<String, Object> parameters,
	...
	private static String getMapParamsToStr(Map<String, Object> paramMap,String requestEncoding) throws IOException{
		StringBuffer params = new StringBuffer();
		// 设置边界
	 ...
	 * @return HTTP响应的字符串
	 */
	public static String downMadGet(String reqUrl, Map<String, Object> parameters,
