package com.xiaoshabao.framework.wechat.apiJW.report.datastatistics.useranalysis;
...
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.dataCube.WxDataCubeStreamUserCumulateParam;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.dataCube.WxDataCubeStreamUserSummaryParam;
		...
		if(accesstoken != null){
			if(getDays(end_date,begin_date) >= 7){
				...
				for (Object object : array) {
					userAnalysisRtnInfo = JSON.toJavaObject((JSONObject) object,
