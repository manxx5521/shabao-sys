package com.xiaoshabao.framework.wechat.apiJW.coupon.consume;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.xiaoshabao.framework.wechat.apiJW.core.common.WxstoreUtils;
import com.xiaoshabao.framework.wechat.apiJW.coupon.consume.model.ConsumeRtnInfo;
import com.xiaoshabao.framework.wechat.apiJW.coupon.consume.model.EncryptRtnInfo;
...
public class JwCardConsumeAPI {
	 ...
	 * @return
	 */
	public static ConsumeRtnInfo doConsume(String newAccessToken, String code,
			String card_id) {
		if (newAccessToken != null) {
			...
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST",
					json);
			ConsumeRtnInfo consumeRtnInfo = JSON.toJavaObject(
	 ...
	 * @return
	 */
	public static EncryptRtnInfo doDecrypt(String newAccessToken,
			String encrypt_code) {
		if (newAccessToken != null) {
			...
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST",
					json);
			EncryptRtnInfo encryptRtnInfo =JSON.toJavaObject(
