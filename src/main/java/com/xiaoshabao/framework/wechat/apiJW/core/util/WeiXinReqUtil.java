package com.xiaoshabao.framework.wechat.apiJW.core.util;
...
public class WeiXinReqUtil {
	...
	public static void initReqConfig(String configName) throws JDOMException, IOException{
		...
		for(Element mapping :lstMapping){
			...
			String mappingHandler ="com.xiaoshabao.framework.wechat.api.core.handler.impl.WeixinReqDefaultHandler";
