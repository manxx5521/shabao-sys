package com.xiaoshabao.framework.wechat.apiJW.third;
...
import com.xiaoshabao.framework.wechat.apiJW.third.model.ApiAuthorizerToken;
import com.xiaoshabao.framework.wechat.apiJW.third.model.ApiAuthorizerTokenRet;
import com.xiaoshabao.framework.wechat.apiJW.third.model.ApiComponentToken;
import com.xiaoshabao.framework.wechat.apiJW.third.model.ApiGetAuthorizer;
import com.xiaoshabao.framework.wechat.apiJW.third.model.ApiGetAuthorizerRet;
import com.xiaoshabao.framework.wechat.apiJW.third.model.GetPreAuthCodeParam;
import com.xiaoshabao.framework.wechat.apiJW.third.model.ReOpenAccessToken;
...
public class JwThirdAPI {
	...
	public static String getAccessToken(ApiComponentToken apiComponentToken) throws WexinReqException{
		...
		String jsonString =JSON.toJSONString(apiComponentToken);
	...
	public static String getPreAuthCode(String component_appid, String component_access_token) throws WexinReqException{
		...
		String jsonString =JSON.toJSONString(getPreAuthCodeParam);
		JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", jsonString);
		if (result.containsKey("errcode")) {
	...
	public static ApiAuthorizerTokenRet apiAuthorizerToken(ApiAuthorizerToken apiAuthorizerToken,String component_access_token) throws WexinReqException{
		...
		String jsonString =JSON.toJSONString(apiAuthorizerToken);
		JSONObject result = WxstoreUtils.httpRequest(requestUrl,"POST",jsonString);
		ApiAuthorizerTokenRet apiAuthorizerTokenRet = JSON.toJavaObject(result, ApiAuthorizerTokenRet.class);
	...
	public static ApiGetAuthorizerRet apiGetAuthorizerInfo(ApiGetAuthorizer apiGetAuthorizer,String component_access_token) throws WexinReqException{
		...
		String jsonString =JSON.toJSONString(apiGetAuthorizer);
		JSONObject result = WxstoreUtils.httpRequest(requestUrl,"POST", jsonString);
		ApiGetAuthorizerRet apiGetAuthorizerRet = JSON.toJavaObject(result, ApiGetAuthorizerRet.class);
	...
	public static AuthorizerOptionRet apiGetAuthorizerOption(AuthorizerOption authorizerOption,String component_access_token) throws WexinReqException{
		...
		String jsonString =JSON.toJSONString(authorizerOption);
		JSONObject result = WxstoreUtils.httpRequest(requestUrl,"POST",jsonString);
		AuthorizerOptionRet authorizerOptionRet = JSON.toJavaObject(result, AuthorizerOptionRet.class);
	...
	public static AuthorizerSetOptionRet apiSetAuthorizerOption(AuthorizerSetOption authorizerSetOption,String component_access_token) throws WexinReqException{
		...
		String jsonString =JSON.toJSONString(authorizerSetOption);
		JSONObject result = WxstoreUtils.httpRequest(requestUrl,"POST", jsonString);
		AuthorizerSetOptionRet authorizerSetOptionRet = JSON.toJavaObject(result, AuthorizerSetOptionRet.class);
	...
	public static ReOpenAccessToken getAccessTokenByCode(String appid,String code,String grant_type,String component_appid,String component_access_token) throws WexinReqException{
		...
		ReOpenAccessToken reOpenAccessToken = JSON.toJavaObject(result, ReOpenAccessToken.class);
		if (result.containsKey("errcode")) {
			logger.error("获取第三方平台access_token！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
			throw new WexinReqException("获取第三方平台access_token！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
		}
    ...
    public static String sendMessage(Map<String,Object> obj,String ACCESS_TOKEN){
    	...
    	logger.info("--------发送客服消息---------json-----"+jsonString);
    	// 调用接口获取access_token
    	String url = send_message_url.replace("ACCESS_TOKEN",ACCESS_TOKEN);
    	JSONObject jsonObject = WxstoreUtils.httpRequest(url, "POST", jsonString);
