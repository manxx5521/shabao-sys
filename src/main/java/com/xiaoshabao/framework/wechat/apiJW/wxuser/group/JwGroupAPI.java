package com.xiaoshabao.framework.wechat.apiJW.wxuser.group;
...
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.user.BatchGroupMembersUpdate;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.user.Group;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.user.GroupCreate;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.user.GroupDelete;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.user.GroupGet;
...
public class JwGroupAPI {
	...
	public static GroupCreate createGroup(String accesstoken ,String groupName ) throws WexinReqException{
		...
		groupCreate = JSONObject.toJavaObject(result, GroupCreate.class);
		return groupCreate;
	}
