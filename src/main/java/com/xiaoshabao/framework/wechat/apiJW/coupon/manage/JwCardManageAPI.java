package com.xiaoshabao.framework.wechat.apiJW.coupon.manage;


import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.xiaoshabao.framework.wechat.apiJW.core.common.WxstoreUtils;
import com.xiaoshabao.framework.wechat.apiJW.coupon.manage.model.BatchGetCardRtnInfo;
import com.xiaoshabao.framework.wechat.apiJW.coupon.manage.model.CardUpdate;
import com.xiaoshabao.framework.wechat.apiJW.coupon.manage.model.CommCardRtnInfo;
import com.xiaoshabao.framework.wechat.apiJW.coupon.manage.model.DelRtnInfo;
import com.xiaoshabao.framework.wechat.apiJW.coupon.manage.model.GetCardDetailRtnInfo;
import com.xiaoshabao.framework.wechat.apiJW.coupon.manage.model.GetCardRtnInfo;
...
public class JwCardManageAPI {
	...
	public static DelRtnInfo doDelCard(String newAccessToken,String card_id) {
		if (newAccessToken != null) {
			...
			DelRtnInfo delRtnInfo = JSON.toJavaObject(result, DelRtnInfo.class);
			return delRtnInfo;
		}
		return null;
	}
	...
	public static GetCardRtnInfo doGetCard(String newAccessToken,String code,String card_id) {
		if (newAccessToken != null) {
			...
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", json);
			GetCardRtnInfo getCardRtnInfo = JSON.toJavaObject(result, GetCardRtnInfo.class);
	...
	public static  BatchGetCardRtnInfo doBatchGetCard(String newAccessToken,int offset,int count) {
		if (newAccessToken != null) {
			...
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", json);
			BatchGetCardRtnInfo batchGetCardRtnInfo = JSON.toJavaObject(result, BatchGetCardRtnInfo.class);
	...
	public static  GetCardDetailRtnInfo doGetCardDetail(String newAccessToken,String card_id) {
		if (newAccessToken != null) {
			...
			String json = "{\"card_id\":\""+card_id+"\"}";
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", json);
			GetCardDetailRtnInfo getCardDetailRtnInfo = JSON.toJavaObject(result, GetCardDetailRtnInfo.class);
	...
	public static  CommCardRtnInfo doUpdateCode(String newAccessToken,String code,String card_id,String new_code) {
		if (newAccessToken != null) {
			...
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", json);
			CommCardRtnInfo commCardRtnInfo = JSON.toJavaObject(result, CommCardRtnInfo.class);
	...
	public static  CommCardRtnInfo doUpdateCard(String newAccessToken,CardUpdate cardUpdate) {
		if (newAccessToken != null) {
			...
			String jsonString =JSON.toJSONString(cardUpdate);
