package com.xiaoshabao.framework.wechat.apiJW.report.interfacesummary;
...
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.interfacesummary.InterfaceSummaryParam;
import com.xiaoshabao.framework.wechat.apiJW.report.interfacesummary.model.InterfaceSummary;
import com.xiaoshabao.framework.wechat.apiJW.report.interfacesummary.model.InterfaceSummaryHour;
...
//			JSONObject obj = JSONObject.fromObject(param);
			...
			list=JSONArray.parseArray(info.toJSONString(), InterfaceSummaryHour.class);
			return list;
		}
		return null;
	}
	...
	public static List<InterfaceSummary> getInterfaceSummary(String accesstoken,InterfaceSummaryParam param) {
		if (accesstoken != null) {
			...
			JSONArray info = result.getJSONArray("list");
			list=JSONArray.parseArray(info.toJSONString(), InterfaceSummary.class);
			return list;
		}
		return null;
	}
