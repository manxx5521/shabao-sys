...
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.kfaccount.KfOnlineAccountList;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.kfaccount.KfaccountAdd;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.kfaccount.KfaccountDel;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.kfaccount.KfaccountList;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.kfaccount.KfaccountUpdate;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.kfaccount.KfaccountUploadheadimg;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.kfaccount.KfcustomSend;
import com.xiaoshabao.framework.wechat.apiJW.core.util.WeiXinConstant;
import com.xiaoshabao.framework.wechat.apiJW.wxsendmsg.model.WxKfaccount;
...
public class JwKfaccountAPI {
	...
	public static List<WxKfaccount> getAllKfaccount(String accessToken) throws WexinReqException{
		...
		for(int i = 0; i < kf_list.size() ; i++){
			kfaccount = JSONObject.toJavaObject( kf_list.getJSONObject(i), WxKfaccount.class);
	...
	public static List<WxKfaccount> getAllOnlineKfaccount(String accessToken) throws WexinReqException{
		...
		WxKfaccount kfaccount = null;
		for (int i = 0; i < kf_list.size(); i++) {
			kfaccount = JSONObject.toJavaObject(
