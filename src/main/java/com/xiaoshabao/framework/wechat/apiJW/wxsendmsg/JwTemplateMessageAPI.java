...
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.message.IndustryTemplateAdd;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.message.IndustryTemplateMessageSend;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.message.IndustryTemplateSet;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.message.TemplateData;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.message.TemplateMessage;
...
public class JwTemplateMessageAPI {
	...
	public static String setIndustry(String accessToken, String industry_id1,
			String industry_id2) throws WexinReqException {
	...
	public static String addTemplate(String accessToken,
			String template_id_short) throws WexinReqException {
