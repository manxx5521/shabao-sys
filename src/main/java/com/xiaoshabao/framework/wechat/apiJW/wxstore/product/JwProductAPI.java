package com.xiaoshabao.framework.wechat.apiJW.wxstore.product;
...
import com.xiaoshabao.framework.wechat.apiJW.core.common.util.WeixinUtil;
import com.xiaoshabao.framework.wechat.apiJW.wxstore.product.model.CateInfo;
...
import com.xiaoshabao.framework.wechat.apiJW.wxstore.product.model.PropertiesInfo;
import com.xiaoshabao.framework.wechat.apiJW.wxstore.product.model.SkuInfo;
...
public class JwProductAPI {
	...
	public static CommodityRtnInfo doAddCommodity(String newAccessToken, Product product) {
		if (newAccessToken != null) {
			...
			CommodityRtnInfo commodityRtnInfo = JSONObject.toJavaObject(result, CommodityRtnInfo.class);
	...
	public static Product getCommodity(String newAccessToken, String product_id) {
		if (newAccessToken != null) {
			...
			product = JSONObject.toJavaObject(info, Product.class);
			return product;
		}
		return null;
	}
	...
	public static List<CateInfo> getCateSub(String newAccessToken, Integer cate_id) {
		if (newAccessToken != null) {
			...
			cateInfos=JSONArray.parseArray(info.toJSONString(), CateInfo.class);
			return cateInfos;
		}
		return null;
	}
	...
	public static List<SkuInfo> getCateSubSku(String newAccessToken, Integer cate_id) {
		if (newAccessToken != null) {
			...
			skuInfos=JSONArray.parseArray(info.toJSONString(), SkuInfo.class);
			return skuInfos;
		}
		return null;
	}
	...
	public static List<PropertiesInfo> getPropertyByCateId(String newAccessToken, Integer cate_id) {
		if (newAccessToken != null) {
			...
			propertiesInfos=JSONArray.parseArray(info.toJSONString(), PropertiesInfo.class);
