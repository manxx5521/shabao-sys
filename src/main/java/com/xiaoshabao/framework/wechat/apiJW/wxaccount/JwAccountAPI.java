package com.xiaoshabao.framework.wechat.apiJW.wxaccount;
...
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.account.QrcodeActionInfo;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.account.QrcodeCreate;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.account.QrcodeScene;
import com.xiaoshabao.framework.wechat.apiJW.core.req.model.account.ShortUrlCreate;
import com.xiaoshabao.framework.wechat.apiJW.core.util.WeiXinConstant;
import com.xiaoshabao.framework.wechat.apiJW.wxaccount.model.WxQrcode;
...
public class JwAccountAPI {
	...
	public static WxQrcode createQrcode(String accessToken, String scene_str,
		...
		wxQrcode = JSON.toJavaObject(result, WxQrcode.class);
		return wxQrcode;
	}
