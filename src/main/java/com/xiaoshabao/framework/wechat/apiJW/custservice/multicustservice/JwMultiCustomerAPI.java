package com.xiaoshabao.framework.wechat.apiJW.custservice.multicustservice;
...
import com.xiaoshabao.framework.wechat.apiJW.custservice.multicustservice.model.CustService;
    ...
    public boolean isOnlineCustServiceAvailable(String accessToken,String kfAccount) {
        ...
        if (accessToken != null) {
            ...
            if(result != null){
                ...
                custServices=JSONArray.parseArray(info.toJSONString(), CustService.class);
            }
        }
    ...
    public List<ChatRecord> getCustServiceRecordList(String accessToken,String openId,long startTime,long endTime,int pageSize,int pageIndex) {
        ...
        if (accessToken != null && startTime >= 0 && endTime >=0 && pageSize>=0 && pageIndex>0 ) {
            ...
            if(result != null){
                ...
                chatRecods=JSONArray.parseArray(info.toJSONString(), ChatRecord.class);
            }
            return chatRecods;
        }
        return null;
