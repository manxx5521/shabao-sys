package com.xiaoshabao.framework.wechat.apiJW.coupon.location;
...
import com.xiaoshabao.framework.wechat.apiJW.coupon.location.model.Batchadd;
import com.xiaoshabao.framework.wechat.apiJW.coupon.location.model.BatchaddRtn;
import com.xiaoshabao.framework.wechat.apiJW.coupon.location.model.Batchget;
import com.xiaoshabao.framework.wechat.apiJW.coupon.location.model.BatchgetRtn;
import com.xiaoshabao.framework.wechat.apiJW.coupon.location.model.CardInfo;
import com.xiaoshabao.framework.wechat.apiJW.coupon.location.model.CardInfoRtn;
import com.xiaoshabao.framework.wechat.apiJW.coupon.location.model.Getcolors;
import com.xiaoshabao.framework.wechat.apiJW.coupon.location.model.GetcolorsRtn;
...
//	private static String add_card_url = "https://api.weixin.qq.com/card/create?access_token=ACCESS_TOKEN";
	...
	public BatchaddRtn doBatchadd(String accesstoken,Batchadd batchadd) throws WexinReqException {
		if (accesstoken != null) {
			...
			BatchaddRtn batchaddRtn = JSON.toJavaObject(result, BatchaddRtn.class);
			return batchaddRtn;
		}
		return null;
	}
	...
	public BatchgetRtn doBatchget(String accesstoken,Batchget batchget) throws WexinReqException{
		if (accesstoken != null) {
			...
			BatchgetRtn batchgetRtn = JSON.toJavaObject(result, BatchgetRtn.class);
			return batchgetRtn;
		}
		return null;
	}
	...
	public GetcolorsRtn doGetcolors(String accesstoken) throws WexinReqException {
		if (accesstoken != null) {
			...
			GetcolorsRtn getcolorsRtn = JSON.toJavaObject(result, GetcolorsRtn.class);
			return getcolorsRtn;
		}
		return null;
	}
	...
	public CardInfoRtn doAddCard(String accesstoken,CardInfo cardInfo) throws WexinReqException{
		if (accesstoken != null) {
			...
			CardInfoRtn cardInfoRtn = JSON.toJavaObject(result, CardInfoRtn.class);
			return cardInfoRtn;
		}
		return null;
	}
