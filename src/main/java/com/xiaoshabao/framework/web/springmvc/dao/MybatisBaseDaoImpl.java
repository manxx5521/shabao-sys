...
public class MybatisBaseDaoImpl implements BaseDao {
	...
	@Override
	public <T> void update(Class<T> clazz, Object p) throws DaoException {
		// TODO Auto-generated method stub
	...
	@Override
	public <T> void insert(Class<T> clazz, T t) throws DaoException {
		// TODO Auto-generated method stub
	...
	@Override
	public <T> boolean exists(Class<T> clazz, T t) throws DaoException {
	...
	@Override
	public <T> void del(Class<T> clazz, T t) throws DaoException {
		// TODO Auto-generated method stub
	...
	public <T> T getDataSingle(Class<T> clazz, Object param) throws DaoException {
		// TODO Auto-generated method stub
		List<T> list= sqlSession.selectList(clazz.getSimpleName().toLowerCase()
